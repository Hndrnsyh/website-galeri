            ...
            <div class="card mb-2">
              ...
              <div class="card-footer text-center">
                ...
                if (mysqli_num_rows($ceksuka) == 1) { ?>
                  <a href="../config/proses_likeindex.php?fotoid=<?php echo $data['fotoid'] ?>" type="submit" name="batalsuka"><i class="fa fa-heart"></i> </a>
                <?php } else { ?>
                  <a href="../config/proses_likeindex.php?fotoid=<?php echo $data['fotoid'] ?>" type="submit" name="suka"><i class="fa-regular fa-heart"></i> </a>
                <?php }
